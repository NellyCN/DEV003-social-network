...
const db = oh(app);
const createUserEmail = (userName, email, password) => {
...
const signInUserEP = (email, password) => signInWithEmailAndPassword(auth, email, password);
const createPost = async (user, comment) => {
  console.log(auth.currentUser.displayName);
  const documentReference = await Ql(Ta(db, "posts"), {
...
const getPostsOnSnapShot = async (callback) => {
  const queryDb = await jl(Ta(db, "posts"), callback);
  return queryDb;
};
...
const Login = () => {
    ...
    <div class = "container">
        ...
        <div class = "containerBackground">
            <div class ="background">
              <figure class="logo">
                  <img class="logoTravellx" src="/assets/travellx.png" alt="logoTravellx">
              </figure>
              <form class="loginForm" id="idloginForm">
                <p class="wellcomeLogReg">Con\xE9ctate con viajeros, comparte experiencias, recomienda lugares a otros viajeros como t\xFA</p>
                <input class ="controls" id="emailLogin" type="email" name="email" value="" placeholder="Correo Electr\xF3nico">
                <input class ="controls" id="passLogin"type="password" name="password" value="" placeholder="Contrase\xF1a">
                <input class="loginBtn" id ="loginBtn" type="submit" value="INICIAR SESI\xD3N">
                <p class="loginText">O</p>
                <p class="loginText">\xBFA\xDAN NO TIENES UNA CUENTA?</p>
                <a href ="#/register" class="linkViewRegister">REG\xCDSTRATE</a>   
              </form>
            </div>
        </div>
    </div>
  ...
  loginAccount.addEventListener("click", (e) => {
    ...
    signInUserEP(emailLogin, passwordLogin).then((userCredential) => {
      const user = userCredential.user;
      location.href = "#/wall";
      console.log(user);
    }).catch(() => {
      alert("Por favor, verifica tu email y contrase\xF1a o reg\xEDstrate primero antes de loguearte");
...
const Registro = () => {
    ...
    <div class = "container">
        ...
        <div class = "containerBackground">
            <div class ="background">        
                ...
                <h5 class="wellcomeLogReg">Reg\xEDstrate para ver recomendaciones para tu pr\xF2ximo viaje ;)</h5>
                <form class="register" id="idregisterform">
                    <input class ="controls" id="textEmail" type="email" name="email" value="" placeholder="Correo Electr\xF3nico">
                    <input class ="controls" id="iduserName" type="text" name="user" value="" placeholder="Nombre de Usuario">
                    <input class ="controls" id="passwordRegister" type="password" name="password" value="" placeholder="Contrase\xF1a">
                    <input class="registerBtn" id ="registerBtn" type="submit" value="REG\xCDSTRATE">
                    <p class="text-center">Revisa tu email y accede al link para autenticar tu cuenta e <a href="#/login">Inicia Sesi\xF3n</a></p>
                </form>
            </div>  
        </div>
    </div>
  ...
  registerAccount.addEventListener("click", () => {
    ...
    alert("Usuario registrado con \xE9xito! Puedes volver y loguearte ;)");
              ...
              <section class="wallTemplate">
                  ...
                  <form class="createPost" id="idcreatePost">
                      ...
                      <div class="newPost" id="newPost">
                          ...
                          <textarea class="textPost" id="idtextPost" name="textarea" rows="5" cols="40" placeholder="Comparte aqu\xED tus experiencias..."></textarea>
                          <div class="btnpost">    
  ...
  getPostsOnSnapShot((querySnapshot) => {
    ...
    crearPost.addEventListener("click", (e) => {
      ...
      if (editStatus === false) {
        ...
        updatePost(id2, { user: userNamePost, comment: postMessage });
        editStatus = false;
        id2 = "";
      }
    ...
    deleteBtn.forEach((deleteClick) => {
      deleteClick.addEventListener("click", ({ target: { dataset } }) => {
